...
from ssh_library.protocol.messages import (
    Message, DisconnectMessage, ServiceRequestMessage, ServiceAcceptMessage,
    KexInitMessage, UserAuthRequestMessage, UserAuthFailureMessage,
    UserAuthSuccessMessage, ChannelOpenMessage, ChannelOpenConfirmationMessage,
    ChannelOpenFailureMessage, ChannelDataMessage, ChannelCloseMessage
)
from ssh_library.protocol.constants import (
    MSG_DISCONNECT, MSG_IGNORE, MSG_SERVICE_REQUEST, MSG_SERVICE_ACCEPT, MSG_KEXINIT,
    MSG_USERAUTH_REQUEST, MSG_USERAUTH_FAILURE, MSG_USERAUTH_SUCCESS,
    MSG_CHANNEL_OPEN, MSG_CHANNEL_OPEN_CONFIRMATION, MSG_CHANNEL_OPEN_FAILURE,
    MSG_CHANNEL_DATA, MSG_CHANNEL_CLOSE, KEX_COOKIE_SIZE,
    SSH_DISCONNECT_PROTOCOL_ERROR, SSH_OPEN_CONNECT_FAILED
)
...
class TestBaseMessage:
    ...
    def test_message_unpack_generic(self):
        ...
        data = bytes([MSG_IGNORE, 0x42, 0x43])  # MSG_IGNORE doesn't have a specific class
...
class TestDisconnectMessage:
    ...
    def test_disconnect_message_pack_unpack(self):
        ...
        original = DisconnectMessage(SSH_DISCONNECT_PROTOCOL_ERROR, "Test error", "en-US")
...
class TestUserAuthMessages:
    ...
    def test_userauth_request_message(self):
        ...
        msg = UserAuthRequestMessage("testuser", "ssh-connection", "password", b"secret")
    ...
    def test_userauth_request_pack_unpack(self):
        ...
        original = UserAuthRequestMessage("testuser", "ssh-connection", "publickey", b"keydata")
        packed = original.pack()
...
class TestChannelMessages:
    ...
    def test_channel_open_failure_message(self):
        ...
        msg = ChannelOpenFailureMessage(1, SSH_OPEN_CONNECT_FAILED, "Connection failed", "en-US")
