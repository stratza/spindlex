...
from ssh_library.exceptions import SSHException, AuthenticationException
...
class TestAsyncSSHClient:
    ...
    async def test_successful_connection(self, mock_transport_class, mock_open_connection):
    ...
    @patch('asyncio.open_connection')
    @patch('ssh_library.client.async_ssh_client.AsyncTransport')
    async def test_connection_with_public_key(self, mock_transport_class, mock_open_connection):
    ...
    @patch('asyncio.open_connection')
    @patch('ssh_library.client.async_ssh_client.AsyncTransport')
    async def test_connection_with_gssapi(self, mock_transport_class, mock_open_connection):
