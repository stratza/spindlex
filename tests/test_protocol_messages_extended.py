...
from spindlex.protocol.messages import (
    Message, DisconnectMessage, IgnoreMessage, UnimplementedMessage,
    DebugMessage, KexDHInitMessage, KexDHReplyMessage, UserAuthBannerMessage,
    UserAuthPKOKMessage, GlobalRequestMessage, RequestSuccessMessage,
    RequestFailureMessage, ChannelOpenMessage, ChannelOpenConfirmationMessage,
    ChannelOpenFailureMessage, ChannelWindowAdjustMessage, ChannelDataMessage,
    ChannelExtendedDataMessage, ChannelEOFMessage, ChannelCloseMessage,
    ChannelRequestMessage, ChannelSuccessMessage, ChannelFailureMessage,
    KexInitMessage, UserAuthRequestMessage
)
...
def test_channel_open_failure_message():
    msg = ChannelOpenFailureMessage(1, SSH_OPEN_ADMINISTRATIVELY_PROHIBITED, "Denied", "en")
    data = msg.pack()
