...
from ssh_library.transport.forwarding import (
    ForwardingTunnel, LocalPortForwarder, RemotePortForwarder, PortForwardingManager
)
...
class TestLocalPortForwarder:
    ...
    def test_create_tunnel_failure(self, mock_socket_class):
        ...
        with pytest.raises(SSHException, match="Failed to create local port forwarding"):
...
class TestRemotePortForwarder:
    ...
    def test_close_tunnel(self):
        ...
        self.forwarder._send_cancel_tcpip_forward_request.assert_called_once_with("", 8080)
...
class TestPortForwardingManager:
    ...
    def test_create_remote_tunnel(self):
        ...
        with patch.object(self.manager.remote_forwarder, 'create_tunnel') as mock_create:
            mock_create.return_value = "tunnel_id"
    ...
    def test_get_all_tunnels(self):
        ...
        with patch.object(self.manager.local_forwarder, 'get_tunnels') as mock_local:
            with patch.object(self.manager.remote_forwarder, 'get_tunnels') as mock_remote:
    ...
    def test_close_all_tunnels(self):
        ...
        with patch.object(self.manager.local_forwarder, 'close_all') as mock_local:
            with patch.object(self.manager.remote_forwarder, 'close_all') as mock_remote:
    ...
    def test_handle_forwarded_connection(self):
        ...
        with patch.object(self.manager.remote_forwarder, 'handle_forwarded_connection') as mock_handle:
...
class TestSSHClientPortForwarding:
    ...
    def test_create_local_port_forward(self):
        ...
        assert result == "tunnel_id"
        mock_manager.create_local_tunnel.assert_called_once_with(8080, "remote.host", 80, "127.0.0.1")
    ...
    def test_create_remote_port_forward(self):
        ...
        assert result == "tunnel_id"
        mock_manager.create_remote_tunnel.assert_called_once_with(8080, "127.0.0.1", 80, "")
