...
from ssh_library.client.ssh_client import SSHClient, ChannelFile
...
from ssh_library.exceptions import (
    ...
    TransportException, ChannelException
)
...
class TestSSHClient:
    ...
    def test_connect_success_password_auth(self, mock_transport_class, mock_socket_class):
    ...
    @patch('ssh_library.client.ssh_client.socket.socket')
    @patch('ssh_library.client.ssh_client.Transport')
    def test_connect_success_publickey_auth(self, mock_transport_class, mock_socket_class):
