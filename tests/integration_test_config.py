...
class OpenSSHTestConfig:
    ...
    def is_configured(self) -> bool:
        ...
        return (self.host is not None and 
                ...
                (self.password is not None or self.key_filename is not None))
...
class PerformanceTestConfig:
    ...
    def from_environment(cls) -> 'PerformanceTestConfig':
        ...
        return cls(
            ...
            max_file_size=int(os.environ.get('PERF_MAX_FILE_SIZE', str(10 * 1024 * 1024))),
            ...
            connection_iterations=int(os.environ.get('PERF_CONNECTION_ITERATIONS', '10')),
            command_iterations=int(os.environ.get('PERF_COMMAND_ITERATIONS', '50')),
            max_memory_per_connection_kb=int(os.environ.get('PERF_MAX_MEMORY_PER_CONN', '1024')),
...
class IntegrationTestConfig:
    ...
    def from_environment(cls) -> 'IntegrationTestConfig':
        ...
        return cls(
            ...
            cleanup_temp_files=os.environ.get('TEST_CLEANUP_TEMP', 'true').lower() == 'true',
            ...
            retry_failed_tests=os.environ.get('TEST_RETRY_FAILED', 'false').lower() == 'true',
...
def validate_test_environment() -> Dict[str, Any]:
    ...
    for package in optional_packages:
        try:
            ...
            validation_results['warnings'].append(f"Optional package '{package}' not found")
    ...
    try:
        ...
        validation_results['warnings'].append("Cannot check system resources (psutil not available)")
