...
from ssh_library.crypto.pkey import (
    PKey, Ed25519Key, ECDSAKey, RSAKey, 
    load_key_from_file, load_public_key_from_string
)
...
class TestKeyLoading:
    ...
    def test_load_invalid_public_key_string(self):
        ...
        # Test unsupported algorithm
        with pytest.raises(CryptoException):
            load_public_key_from_string("unsupported-algo AAAAB3NzaC1yc2E test@example.com")
