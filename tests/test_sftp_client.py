...
from ssh_library.protocol.sftp_messages import (
    ...
    SFTPAttrsMessage, SFTPOpenDirMessage, SFTPReadDirMessage, SFTPNameMessage,
    SFTPMkdirMessage, SFTPRmdirMessage, SFTPRemoveMessage, SFTPSetStatMessage
)
from ssh_library.protocol.sftp_constants import (
    SFTP_VERSION, SSH_FX_OK, SSH_FX_EOF, SSH_FX_NO_SUCH_FILE,
    SSH_FX_PERMISSION_DENIED, SSH_FXF_READ, SSH_FXF_WRITE,
    SSH_FILEXFER_ATTR_SIZE, SSH_FILEXFER_ATTR_PERMISSIONS
)
from ssh_library.exceptions import SFTPError, ChannelException
...
class TestSFTPClient:
    ...
    def test_get_file_success(self):
        ...
        self.mock_channel.recv.side_effect = [
            ...
            # Read response
            data_data[:4], data_data[4:],
            # EOF response
            eof_data[:4], eof_data[4:],
            # Close response
            close_data[:4], close_data[4:]
        ]
