...
from spindlex.protocol.messages import (
    Message, KexInitMessage, NewKeysMessage, ServiceRequestMessage,
    ServiceAcceptMessage, UserAuthRequestMessage, UserAuthSuccessMessage,
...
def test_userauth_messages():
    ...
    fail = UserAuthFailureMessage(
        authentications=["password", "publickey"],
