...
HOSTKEY_ECDSA_SHA2_NISTP384 = "ecdsa-sha2-nistp384"
HOSTKEY_ECDSA_SHA2_NISTP521 = "ecdsa-sha2-nistp521"
HOSTKEY_RSA_SHA2_256 = "rsa-sha2-256"
HOSTKEY_RSA_SHA2_512 = "rsa-sha2-512"
...
# Rekeying thresholds
REKEY_SEQUENCE_THRESHOLD = 0x80000000  # rekey after 2^31 packets (RFC 4253 §6.4)
MAX_VERSION_LINE_LENGTH = 255  # RFC 4253 §4.2
...
__all__ = [
    ...
    "HOSTKEY_ECDSA_SHA2_NISTP384",
    "HOSTKEY_ECDSA_SHA2_NISTP521",
    "HOSTKEY_ED25519",
    "HOSTKEY_RSA_SHA2_256",
    "HOSTKEY_RSA_SHA2_512",
    "KEX_COOKIE_SIZE",
